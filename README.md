...
```
sh <(wget -O - https://raw.githubusercontent.com/konoff/domain-routing-openwrt/master/getdomains-install.sh)
```
...
### Запуск
```
wget -O - https://raw.githubusercontent.com/konoff/domain-routing-openwrt/master/getdomains-check.sh | sh
```
...
```
wget -O - https://raw.githubusercontent.com/konoff/domain-routing-openwrt/master/getdomains-check.sh | sh -s --lang en
```
...
```
wget -O - https://raw.githubusercontent.com/konoff/domain-routing-openwrt/master/getdomains-check.sh | sh -s dump
```
